...
class OwOpportunities extends StatefulWidget {
  const OwOpportunities({super.key});

  @override
  State<OwOpportunities> createState() => _OwOpportunitiesState();
}

class _OwOpportunitiesState extends State<OwOpportunities> with SingleTickerProviderStateMixin {
        ...
        ...opportunitiesData.map((item) => TableRow(
          children: [
            ...
            Padding(
              ...
              child: Text(
                item['feasibility'],
                style: const TextStyle(color: AppUI.owMainColor, fontWeight: FontWeight.bold),
              ),
            ),
          ],
        )),
