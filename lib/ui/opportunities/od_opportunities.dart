...
import 'package:co_spirit/ui/opportunities/od_opportunity_view.dart';
...
class ODOpportunitiesPage extends StatefulWidget {
  const ODOpportunitiesPage({super.key});

  @override
  State<ODOpportunitiesPage> createState() => _ODOpportunitiesPageState();
}

class _ODOpportunitiesPageState extends State<ODOpportunitiesPage> {
