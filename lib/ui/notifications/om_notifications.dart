...
class OMNotificationScreen extends StatefulWidget {
  ...
  const OMNotificationScreen({super.key, required this.buttonColor, required this.mainColor});

  @override
  State<OMNotificationScreen> createState() => _OMNotificationScreenState();
}
