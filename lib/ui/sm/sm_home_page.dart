...
import 'package:co_spirit/ui/sm/projects_overview.dart';
...
class _SMHomePageState extends State<SMHomePage> {
  int pageIndex = 1;
  List pages = [
    const RACIViewPageNeo(),
    const ProjectsOverviewNeo(isSm: true),
    const SolutionsScreenNeo(isSM: true),
