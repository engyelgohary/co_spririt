                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: user.pictureUrl == null
                                  ...
                                  size: AppUtil.responsiveWidth(context) * 0.3,
                                  elevation: 4
                              )
                                  : Icon(Icons.person),
                            ),
                          ...
                          suffixIcon: IconButton(
                            onPressed: () {
                              showModalBottomSheet(
                                ...
                                isScrollControlled: true, // Ensures the form fits the content
                                builder: (BuildContext context) {
                                  return BlocProvider.value(
                                    value: context.read<SettingsCubit>(), // Provide the same SettingsCubit
