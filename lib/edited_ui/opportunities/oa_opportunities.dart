...
class OaOpportunities extends StatefulWidget {
  const OaOpportunities({super.key});

  @override
  State<OaOpportunities> createState() => _OaOpportunitiesState();
}

class _OaOpportunitiesState extends State<OaOpportunities> with SingleTickerProviderStateMixin {
        ...
        ...opportunitiesData.map((item) => TableRow(
          children: [
            ...
            Padding(
              ...
              child: Text(
                item['feasibility'],
                style: const TextStyle(color: AppUI.oaMainColor, fontWeight: FontWeight.bold),
              ),
            ),
          ],
        )),
