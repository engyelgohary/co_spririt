...
class OANotificationScreen extends StatefulWidget {
  static const String routName = 'Notification Collaborator';
  const OANotificationScreen({super.key});

  @override
  State<OANotificationScreen> createState() => _OANotificationScreenState();
}

class _OANotificationScreenState extends State<OANotificationScreen> {
